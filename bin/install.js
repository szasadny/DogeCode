...
const OPENCODE_SKILL_DIRS  = ['doge', 'doge-commit', 'doge-review', 'doge-help', 'doge-stats', 'doge-compress', 'cavecrew'];
const OPENCODE_AGENT_FILES = ['cavecrew-investigator.md', 'cavecrew-builder.md', 'cavecrew-reviewer.md'];
const OPENCODE_COMMAND_FILES = ['doge.md', 'doge-commit.md', 'doge-review.md', 'doge-compress.md', 'doge-stats.md', 'doge-help.md'];
